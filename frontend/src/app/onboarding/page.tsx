      ...
      <main className="mx-auto flex min-h-[calc(100vh-4.5rem)] max-w-3xl flex-col items-center justify-center px-6 py-16 text-center">
        {step === "welcome" && (
          <Fade>
            ...
            <button className="ob-btn mt-12 rounded-2xl px-8 py-4 text-lg font-semibold" onClick={() => setStep("register")}>
        ...
        {step === "register" && (
          <Fade>
            ...
            <StepButtons onBack={() => setStep("welcome")} onNext={register} busy={busy} label={busy ? "Creating…" : "Create account →"} />
          </Fade>
        )}
        ...
        {step === "goal" && (
          <Fade>
            ...
            <StepButtons
              ...
              onNext={() => title.trim() && setStep("deadline")}
              disabled={!title.trim()}
            />
          </Fade>
        )}
        ...
        {step === "deadline" && (
          <Fade>
            ...
            <StepButtons
              onBack={() => setStep("goal")}
              onNext={() => dLeft !== null && dLeft >= 0 && setStep("materials")}
        ...
        {step === "materials" && (
          <Fade>
            ...
            <StepButtons
              ...
              onNext={() => namedMaterials.length > 0 && setStep("howfar")}
        ...
        {step === "howfar" && (
          <Fade>
            ...
            <StepButtons onBack={() => setStep("materials")} onNext={() => setStep("availability")} />
          </Fade>
        )}
        ...
        {step === "availability" && (
          <Fade>
            ...
            {error && <ErrorLine msg={error} />}
            <StepButtons
              onBack={() => setStep("howfar")}
              onNext={() => totalHours > 0 && setStep("building")}
        ...
        {step === "launch" && launched && (
          <Fade>
            ...
            <p className="mt-10 text-8xl font-bold tnum">{launched.days}</p>
...
function Fade({ children }: { children: React.ReactNode }) {
  return <div className="ob-fade flex w-full flex-col items-center">{children}</div>;
}
...
function DayColumn({
  ...
  return (
    <div className={`ob-glass flex h-52 flex-col items-center rounded-3xl px-2 py-4 ${active ? "" : "opacity-60"}`}>
      ...
      <div className="mt-auto flex flex-col items-center gap-2">
        ...
        <span className="text-2xl font-bold tnum">{active ? hours : "—"}</span>
