    ...
    <DarkShell>
      <div className="pt-10">
        ...
        <div className="mt-6 space-y-5 text-lg leading-relaxed text-white/70">
          ...
          <p>
            <span className="font-semibold text-white">No selling, no ads, no tracking.</span> Your
            study data is never sold or shared with advertisers, and there are no third-party
            trackers in the app.
          </p>
          <p>
            <span className="font-semibold text-white">Your data is yours.</span> You can request a
